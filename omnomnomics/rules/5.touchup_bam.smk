...
rule touchup_bam:
    input:
        ...
        #extrafile = f"{master_config['input_folders'][master_config['touchup_rule_num']-1]}/{{sample2}}.extra_4.tmp" if 4 in themode else None
    output:
        ...
        f"{master_config['output_folders'][master_config['touchup_rule_num']-1]}/{{sample2}}.extra_5.tmp"
    params:
    ...
    benchmark:
        f"{master_config['output_folders'][master_config['touchup_rule_num']-1]}/{{sample2}}_touchupbam_benchmark.tsv"
    run:
