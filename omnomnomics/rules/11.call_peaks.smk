...
rule call_peaks:
    ...
    output:
        ...
        f"{master_config['output_folders'][master_config['callpeaks_rule_num']-1]}/extra_11.tmp"
    params:
    ...
    benchmark:
        f"{master_config['output_folders'][master_config['callpeaks_rule_num']-1]}/call_peaks_benchmark.tsv"
    run: 
