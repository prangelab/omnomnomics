...
The DE_calling folder contains RNA count tables generated from BAM files and currently serves as the staging area for future built-in RNA differential-expression analysis.
...
12:	RNA only:	   Call DE genes (planned, not yet implemented)
